...
class HomogeneousBin:
    """Class representation of a bin containing a single signal value."""
...
class HeterogeneousBin:
    """Class representation of a bin containing more than one signal value."""
...
class Rediscretize:
    ...
    def rediscretize_chromosome(self, df):
        ...
        size `self.step` fit into each genomic interval.
